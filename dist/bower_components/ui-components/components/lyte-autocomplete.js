     ...
     data : function (){
      //user data
            return {
               ...
               ltPropDropdownWidth : Lyte.attr('string',{'default' : ''}),
   ...
   errorMessage : function(flag){
     ...
     methods : {
        ...
        "valSet":function(event,selectedVal){
                  ...
                  while(targetElem.tagName != 'LYTE-DROP-ITEM')
                    {
                        ...
                        if(this.getMethods('onSelect'))
                            {
                              ...
                              if(this.getData('ltPropYield'))
                               ...
                               this.executeMethod('onSelect', value)
                            }
                      }          
            },
        ...
        filteringArray : function(searchList, targetList, val){
             ...
             if(this.getMethods('onSearch'))   
                {
                  flag = this.executeMethod('onSearch',visibleList,this.autocompleteComp);
                }
             if(flag != false)
                {
                  for(var i = 0; i < searchList.length; i++)
                            ...
                            if(this.getData('ltPropUrl'))
                          ...
                          else
                              {
                                 if(this.getMethods('onExtSearch'))
                                    {
                                      this.executeMethod('onExtSearch',val);
                                    }
                              }
                      }
                     else
