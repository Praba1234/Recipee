...
_template:"<template tag-name=\"lyte-navigator\">\t<div class=\"lyteNavigator\">\t\t<div class=\"lyteNavigator lyteDoubleBack lyteIconDoubleBack\" onclick=\"{{action('goFirst')}}\"></div>\t\t<div class=\"lyteNavigator lyteSingleBack lyteIconSingleBack\" onclick=\"{{action('onBackward')}}\"></div>\t\t<div class=\"lyteNavigatorMidPoint\">{{startRecord}} <span class=\"lyteNavigatorText\">{{ltPropMiddleText}}</span> {{endRecord}}</div> \t\t<div class=\"lyteNavigator lyteSingleFront lyteIconSingleFront\" onclick=\"{{action('onForward')}}\"></div>\t\t<div class=\"lyteNavigator lyteDoubleFront lyteIconDoubleFront\" onclick=\"{{action('goLast')}}\"></div>\t</div></template>",
_dynamicNodes : [{"type":"attr","position":[1,1]},{"type":"attr","position":[1,3]},{"type":"text","position":[1,5,0]},{"type":"text","position":[1,5,2,0]},{"type":"text","position":[1,5,4]},{"type":"attr","position":[1,7]},{"type":"attr","position":[1,9]}],
_observedAttributes :["ltPropPerpage","ltPropValue","ltPropRecords","ltPropMoreRecords","ltPropMiddleText"],
	...
	actions : {
			 ...
			 "onBackward" : function(){
			        ...
			        if(this.getMethods('onPrevious'))
				    	 {
				    		this.executeMethod('onPrevious', z)
				    	}
				}, 
			 "goFirst" : function(){
			       ...
			       if( this.getMethods('onHome'))
				    	 {
				    		this.executeMethod('onHome', this.getData('ltPropValue'));
				    	 }
				}, 
			 "goLast" : function(){
				    var firstIndex = this.getData('ltPropValue'), perPage = this.getData('ltPropPerpage'), MaxRecords = this.getData('ltPropRecords')
