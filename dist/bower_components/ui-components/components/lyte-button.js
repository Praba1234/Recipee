...
_template:"<template tag-name=\"lyte-button\">\t\t<button type=\"{{ltPropType}}\" onclick=\"{{action('check',event)}}\" class=\"{{ltPropBClass}}\" value=\"{{ltPropValue}}\" style=\"{{ltPropBStyle}}\" tabindex=\"{{ltPropTabindex}}\" id=\"{{ltPropId}}\" name=\"{{ltPropName}}\" autofocus=\"{{ltPropAutofocus}}\" disabled=\"{{ltPropDisabled}}\">\t\t\t<lyte-yield yield-name=\"text\"></lyte-yield>\t\t</button></template>",
_dynamicNodes : [{"type":"attr","position":[1]},{"type":"insertYield","position":[1,1]}],
_observedAttributes :["ltPropName","ltPropDisabled","ltPropAutofocus","ltPropAppearance","ltPropId","ltPropType","ltPropValue","ltPropTabindex","ltPropStyle","ltPropSize","ltPropBackgroundColor","ltPropColor","lyteShortcut"],	
	data: function(){
		return {
	...
	changeClass:function(){
		this.setData('ltPropBClass','lyte-button')
		if(this.getData('ltPropAppearance').indexOf('default') != -1){
