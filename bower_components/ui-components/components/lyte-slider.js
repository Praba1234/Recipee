...
_dynamicNodes : [{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,5]},{"type":"if","position":[1,5],"cases":{"true":{"dynamicNodes":[]}},"default":{}},{"type":"attr","position":[1,6]},{"type":"if","position":[1,6],"cases":{"true":{"dynamicNodes":[{"type":"insertYield","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"for","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,3,0]}]}]}},"default":{}}]},"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,5]},{"type":"if","position":[1,5],"cases":{"true":{"dynamicNodes":[]}},"default":{}},{"type":"attr","position":[1,6]},{"type":"if","position":[1,6],"cases":{"true":{"dynamicNodes":[{"type":"insertYield","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"for","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,3,0]}]}]}},"default":{}}]}},"default":{}}],
			...
			if(this.getData('ltPropRangeHandler'))
				{
					if(!this.getData('ltPropMinValue'))
						{
							this.setData('ltPropMinValue',this.getData('ltPropMin'));
							this.setData('ltPropSelectedValue1',this.getData('ltPropMin'));
						}
					if(!this.getData('ltPropMaxValue'))
						{
							this.setData('ltPropMaxValue',this.getData('ltPropMax'));
							this.setData('ltPropSelectedValue2',this.getData('ltPropMax'))
						}
					...
					if(!this.getData('ltPropRangeHandler'))
						{
							if(this.getMethods('onChange'))	
								{
									this.executeMethod('onChange',this.getData('ltPropSelectedValue1'))	
								}
							if(this.getMethods('onSelect') && flag)	
								{
									this.executeMethod('onSelect',this.getData('ltPropSelectedValue1'))	
								}
						}
					else
						{
							if(this.getMethods('onChange'))	
								{
									this.executeMethod('onChange', this.getData('ltPropSelectedValue1'), this.getData('ltPropSelectedValue2'));	
								}
							if(this.getMethods('onSelect') && flag)	
								{
									this.executeMethod('onSelect', this.getData('ltPropSelectedValue1'), this.getData('ltPropSelectedValue2'));	
								}
						}
				}			
			},
			...
			if(!this.getData('ltPropRangeHandler'))
				{
					if(this.getData('ltPropDirection').indexOf('Horizontal')==-1)
						{
							this.setData('ltPropSelectedValue1',this.selectedVal.call(this,'clientHeight','ltPropHeight').toString());
						}
					else
						{
							this.setData('ltPropSelectedValue1',this.selectedVal.call(this,'clientWidth','ltPropWidth').toString());
						}
				}
			else
				{
					if(this.getData('ltPropDirection').indexOf('Horizontal')==-1)
						{
							this.setData('ltPropSelectedValue1',this.selectedVal.call(this,'clientHeight','ltPropHeight', $L('div.lyteHandler1', this.$node).e[0], 'top').toString());
							this.setData('ltPropSelectedValue2',this.selectedVal.call(this,'clientHeight','ltPropHeight', $L('div.lyteHandler2', this.$node).e[0],'top').toString());
						}
					else
						{
							this.setData('ltPropSelectedValue1', this.selectedVal.call(this,'clientWidth','ltPropWidth', $L('div.lyteHandler1', this.$node).e[0],'left').toString());
							this.setData('ltPropSelectedValue2',selectedVal2=this.selectedVal.call(this,'clientWidth','ltPropWidth', $L('div.lyteHandler2', this.$node).e[0],'left').toString());
						}
				}	
		},
