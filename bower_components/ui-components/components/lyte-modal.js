...
_observedAttributes :["ltPropShow","ltPropFreeze","ltPropShowCloseButton","ltPropCloseOnEscape","ltPropTransition","ltPropOffset","ltPropDimmer","ltPropDraggable","ltPropAllowMultiple","ltPropScrollable","ltPropMaxHeight","ltPropMaxWidth","ltPropWidth","ltPropHeight","ltPropWrapperClass","ltPropHeading","ltPropButtons","ltPropButtonPosition","ltPropShowCopy"],
    ...
    onBeforeCloseHandling : function(){
        ...
        if(result === undefined || result){
            ...
            if(modalEle.classList.contains('lyteModalFromTop')){
                modalEle.classList.remove('lyteModalFromTop');
            }
            if(modalEle.classList.contains('lyteModalFromBottom')){
                modalEle.classList.remove('lyteModalFromBottom');
            }
            if(modalEle.classList.contains('lyteModalFromLeft')){
                modalEle.classList.remove('lyteModalFromLeft');
            }
            if(modalEle.classList.contains('lyteModalFromRight')){
                modalEle.classList.remove('lyteModalFromRight');
            }
            if(modalEle.classList.contains('lyteModalFadeIn')){
                modalEle.classList.remove('lyteModalFadeIn');
            }
            if(this.$node.ltProp('freeze')){
